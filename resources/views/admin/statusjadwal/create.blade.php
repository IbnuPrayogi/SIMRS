                                ...
                                <div class="card">
                                        <div class="card-body">
                                            <div class="modal-body">Apakah anda yakin ingin
                                                ...
                                                <span
                                                    class="badge bg-secondary">{{ $status_jadwal->nama_bagian }}{{ $statusjadwal->bulan.'-'.$statusjadwal->tahun }}</span>
                                            </div>
                                            ...
                                            <form method="POST" action="{{route('disposisi.tambahdisposisi', ['id'=>$surat->id,'jenis'=>$jenis])}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" id="lokasiArsip" name="status" style="background-color: #E0E0E0;" value={{ $statusjadwal->status }}>
