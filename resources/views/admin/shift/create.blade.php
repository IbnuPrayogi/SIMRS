                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('shift.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="namaShift" placeholder="Nama Shift" style="background-color: #E0E0E0;" name="nama_shift">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="namaShift" class="col-md-4 col-form-label">Kode Shift</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="kodeShift" placeholder="Nama Shift" style="background-color: #E0E0E0;" name="kode_shift">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="bagian" class="col-md-4 col-form-label">Bagian</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="bagian" placeholder="Bagian" style="background-color: #E0E0E0;" name="bagian">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="jamMasuk" class="col-md-4 col-form-label">Jam Masuk</label>
                                            <div class="col-md-8">
                                                <input type="time" class="form-control" id="jamMasuk" style="background-color: #E0E0E0;" name="jam_masuk">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="jamPulang" class="col-md-4 col-form-label">Jam Pulang</label>
                                            <div class="col-md-8">
                                                <input type="time" class="form-control" id="jamPulang" style="background-color: #E0E0E0;" name="jam_pulang">
                                            </div>
                                        </div>
