                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('shift.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="date" class="form-control" id="jamMasuk" style="background-color: #E0E0E0;" name="jam_masuk">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="jamPulang" class="col-md-4 col-form-label">Jam Pulang</label>
                                            <div class="col-md-8">
                                                <input type="date" class="form-control" id="jamPulang" style="background-color: #E0E0E0;" name="jam_pulang">
                                            </div>
                                        </div>
