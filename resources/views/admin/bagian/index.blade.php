                    ...
                    <div class="card-header" style="background-color: blue; color: white; border-bottom: 2px solid white;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="{{ route('bagian.create') }}"><button class="button" id="openPopupButton"
                                        style="font-size: 15px; border-radius: 20px;">
                                        Tambah Bagian Baru</button></a>
                            </div>
                        </div>
                                                ...
                                                @foreach ($bagians as $bagian)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a role="button"  class="delete-button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm{{$bagian->id}}"><button
